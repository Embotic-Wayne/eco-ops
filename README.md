...
🌊 Streaming Complexity: Architecting the NDJSON stream to accumulate agent states without blocking the UI.
...
## **What I learned** 
🧠 How to master LangGraph reducers and stream node updates to a React frontend.
